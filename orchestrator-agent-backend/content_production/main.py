...
logger = logging.getLogger("content-production")
...
async def invoke_stream(payload: Dict, _context=None):
    """Streaming AgentCore entrypoint for the content production orchestrator."""
...
if __name__ == "__main__":
    logger.info("Starting content-production agent on port %d", PORT)
